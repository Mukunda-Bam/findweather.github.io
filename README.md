...
I have used axios library to make the HTTP request to external service. In this case, the external service is OpenWeatherMap API. Here the device's location: lattitude and longitude. This API dta The API collects the data and returns the data whenever user enters city name to find the weather. This weather API gives the data in easy to understand form.
